...
\caption[Systems development life cycle]%
	...
	stages of development~\autocite{IRM-SDLC:DoJ:2003}. The stages are
	\begin{description*}
		\item[Planning] This stage is where a plan for how
			the project will be managed is created and
			resources for ;
		\item[Analysis] ;
		\item[Design] this  ;
		\item[Implementation] ;
		\item[Testing] testing and integration ;
		\item[Maintenance] possibly the longest .
	\end{description*}
}\label{fig:sdlc}
