...
converting the existing \acrshort{ORION} 3~\autocite{ORION_Santamaria-Pang2015} system from
...
deliverables while engineering deliverables are covered in \cref{sec:objectives}.
...
\caption[Systems development life cycle]%
	...
	\begin{enumerate*}[label={\alph*)}]
		...
		\enumdescitem{Maintenance} In this phase, the system is put in
...
{ % backwards compatibility and digital preservation
	...
	known as \emph{dependency hell}~\autocite{anderson2000end}.
	...
	development life cycle} becomes more important (see \cref{fig:sdlc}).
...
\begin{quote}
	...
	process.
	\end{fancyquote}
	\qauthor{Michael Nielsen\footnote{https://lists.okfn.org/pipermail/open-science/2011-July/000907.html}}
\end{quote}
...
discussion of the benefits of this decision are discussed in \cref{ch:analysis}.
