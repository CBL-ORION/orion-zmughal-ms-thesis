...
\begin{quote}
	...
	process.
	\end{fancyquote}
	\qauthor{Michael Nielsen\footnote{https://lists.okfn.org/pipermail/open-science/2011-July/000907.html}} % TODO add more info about quote
\end{quote}
...
% to software errors
Software causing retractions~\autocite{Miller2006,Merali2010}
...
teaching best practices through the Software Carpentry~\cite{Wilson2006,Wilson2012}
