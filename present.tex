...
\ifx \printpresentnotes \undefined
% no notes
\else
...
\begin{frame}\frametitle{Neuron reconstruction}
	% TODO
	\begin{tabular}{ccc}
	\vertcenterimage{\includegraphics[width=0.4\textwidth]{gfx/present/neuron-vol}}
	&
	\arrowright
	&
	\vertcenterimage{\includegraphics[width=0.4\textwidth]{gfx/present/neuron-trace}}
	\end{tabular}
	\note{
		problem with manual tracing
	}
\end{frame}
