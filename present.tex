...
\begin{frame}\frametitle{Digital neuron reconstruction}
	\begin{multicols}{2}
	\begin{itemize}
		\item<1-> The early days (late 1960s): Glaser and Van der loos, 1965; Blinkov and Ivanitskii, 1968; Macku and Hradil, 1968
...
\begin{frame}\frametitle{\subsubsecname}
	...
	\vertcenterimage{\includegraphics[width=0.3\textwidth]{gfx/vaa3D-DIADEM-1-CF_1-MIP.png}} & \vertcenterimage{\includegraphics[width=0.3\textwidth]{gfx/vaa3D-DIADEM-2-HCA3-Section-1-MIP.png}} & \vertcenterimage{\includegraphics[width=0.2\textwidth]{gfx/vaa3D-DIADEM-3-NL1-01-MIP.png}} \\
	\vertcenterimage{\includegraphics[width=0.2\textwidth]{gfx/vaa3D-DIADEM-1-CF_1-3D.png}}  & \vertcenterimage{\todofig{gfx/vaa3D-DIADEM-2-HCA3-Section-1-3D.png}}  & \vertcenterimage{\includegraphics[width=0.2\textwidth]{gfx/vaa3D-DIADEM-3-NL1-01-3D.png}}
	\end{tabular}
	\end{center}
	\note{
...
\begin{frame}\frametitle{\subsubsecname}
	...
	\vertcenterimage{\todofig{gfx/vaa3D-DIADEM-4-NPF-MIP.png}} & \vertcenterimage{\todofig{gfx/vaa3D-DIADEM-5-OP-MIP.png}} & \vertcenterimage{\todofig{gfx/vaa3D-DIADEM-6-CL-MIP.png}} \\
	\vertcenterimage{\todofig{gfx/vaa3D-DIADEM-4-NPF-3D.png}} & \vertcenterimage{\todofig{gfx/vaa3D-DIADEM-5-OP-3D.png}} & \vertcenterimage{\todofig{gfx/vaa3D-DIADEM-6-CL-3D.png}}
	\end{tabular}
	\end{center}
	\note{
		[\tbackground{explain DIADEM Challenge; data sets; outcomes}]
...
\begin{frame}\frametitle{DIADEM datasets}
	% TODO
\end{frame}
