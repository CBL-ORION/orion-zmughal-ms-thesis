...
\caption[Segmentation process]{\textbf{Segmentation process}}\label{fig:proc-segmentation}
\end{figure}
...
\caption[Tracing process]{\textbf{Tracing process}}\label{fig:proc-tracing}
\end{figure}
